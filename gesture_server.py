...
@app.route('/')
def home():
    return "Gesture Recognition Server is running! Use POST /run to start the game."
...
def run_script():
    try:
        ...
        if script_name == "gesture.py":
            ...
            return jsonify({"message": "Gesture recognition game started successfully!"})
